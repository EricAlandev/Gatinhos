...
export default function Entrar() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/entrar`, formData);
  ...
  return (
    <div className='min-h-[719px] md:min-h-[684px] ml-4 mr-4 '>
      ...
      className='md:max-w-[1200px] md:mx-auto mt-[30px] md:mt-[120px]'
      >
        ...
        <div className='flex justify-center md:mt-[30px] md:mb-[50px]'>
          <button type="submit" 
          className='min-w-[200px] md:min-w-[400px] mt-[10px] md:mt-0 mb-[10px] md:mb-0 p-2 text-[#D1D1D1] bg-[#373939] rounded-[8px] cursor-pointer md:hover:transform md:hover:scale-[1.05] duration-300'
          >Entrar</button>
        </div>
      </form>
    </div>
